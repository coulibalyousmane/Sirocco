...
/// meme decision structurante que <c>Sirocco.HarConvert</c> (voir ROADMAP.md, "Implications pour
...
public static class OpenApiConverter
{
    ...
    private static string Render(string workflowName, List<ConvertedStep> steps)
    {
        ...
        code.AppendLine("// Genere par Sirocco.OpenApiConvert : les en-tetes d'authentification et les valeurs de");
