...
/// <para>
/// Meme raison que <c>ScenarioDefinitionDto</c> cote <c>Sirocco.Scenarios</c> :
...
internal sealed class StepStatisticsDto
{
    ...
    public StepStatistics ToDomain() => new()
    {
        ...
        Response = Response,
        Service = Service,
        // Non transporte par ce DTO : Sirocco.Compare ne diffe que des centiles deja
