...
/// <c>Tempest.Domain.Execution.IWorkflow</c> exactement comme <c>scenarios/scripted-checkout.csx</c>,
...
public static class HarConverter
{
    ...
    private static string Render(string workflowName, List<ConvertedStep> steps)
    {
        ...
        code.AppendLine("// Genere par Tempest.HarConvert : verifier l'authentification et les cookies avant de");
