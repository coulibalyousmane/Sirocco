...
namespace Sirocco.Extensions.Sse;

/// <summary>
/// Deuxieme protocole de reference de la roadmap phase 6 : contrairement a
/// <c>Sirocco.Extensions.Sql</c>, qui validait le contrat de plugin contre un protocole reellement
...
/// attendus) se configure par variable d'environnement, comme <c>Sirocco.SamplePlugin</c>.
/// </para>
/// <para>
...
{
    private const string PATH_ENVIRONMENT_VARIABLE = "SIROCCO_SSE_PLUGIN_PATH";
    private const string EVENT_COUNT_ENVIRONMENT_VARIABLE = "SIROCCO_SSE_PLUGIN_EVENT_COUNT";
    private const string TIMEOUT_SECONDS_ENVIRONMENT_VARIABLE = "SIROCCO_SSE_PLUGIN_TIMEOUT_SECONDS";
