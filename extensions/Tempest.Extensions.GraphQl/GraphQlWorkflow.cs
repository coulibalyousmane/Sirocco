...
namespace Tempest.Extensions.GraphQl;

/// <summary>
/// Quatrieme et dernier protocole de reference de la roadmap phase 6 : comme
/// <c>Tempest.Extensions.Sse</c>, reste au-dessus de HTTP plutot que d'en changer, mais valide un
...
/// (<c>DynamicCheckoutWorkflow</c>, <c>Tempest.SamplePlugin</c>...) utilise au contraire le code de
...
/// pour un identifiant tire dans <c>[1, TEMPEST_GRAPHQL_PLUGIN_PRODUCT_ID_MAX]</c>) — memes deux
/// natures d'operation (lecture/ecriture) que <c>Tempest.Extensions.Sql</c>, sous revetement HTTP.
/// </para>
/// <para>
/// Limite assumee, comme les protocoles de reference precedents : aucune configuration injectee par
/// Tempest, ce plugin lit la sienne (chemin, borne haute des identifiants) depuis des variables
...
{
    private const string PATH_ENVIRONMENT_VARIABLE = "TEMPEST_GRAPHQL_PLUGIN_PATH";
