...
namespace Sirocco.Extensions.Sql;
...
/// </para>
/// <para>
/// Limite assumee, comme <c>Sirocco.SamplePlugin</c> : aucune configuration injectee par Sirocco,
...
/// cherche par defaut a cote de l'assembly <b>hote</b> (<c>Sirocco.Cli</c>), qui ne l'a jamais
...
public sealed class SqlWorkflow : IWorkflow
{
    ...
    public SqlWorkflow()
    {
        string defaultPath = Path.Combine(Path.GetTempPath(), "sirocco-sql-plugin.db");
