...
namespace Sirocco.Extensions.Mqtt;

/// <summary>
/// Troisieme protocole de reference de la roadmap phase 6 : contrairement a
/// <c>Sirocco.Extensions.Sse</c>, qui restait au-dessus de HTTP, celui-ci revient a un protocole
/// reellement different comme <c>Sirocco.Extensions.Sql</c> — mais oriente publication/abonnement
...
/// Sirocco, ce plugin lit la sienne (hote, port, prefixe de sujet, delai maximal par iteration)
/// depuis des variables d'environnement.
/// </para>
/// <para>
/// Confirmation reelle plutot que nouvelle trouvaille : comme <c>Sirocco.Extensions.Sql</c>, ce
...
{
    private const string HOST_ENVIRONMENT_VARIABLE = "SIROCCO_MQTT_PLUGIN_HOST";
    private const string PORT_ENVIRONMENT_VARIABLE = "SIROCCO_MQTT_PLUGIN_PORT";
    private const string TOPIC_PREFIX_ENVIRONMENT_VARIABLE = "SIROCCO_MQTT_PLUGIN_TOPIC_PREFIX";
    private const string TIMEOUT_SECONDS_ENVIRONMENT_VARIABLE = "SIROCCO_MQTT_PLUGIN_TIMEOUT_SECONDS";
    private const string DEFAULT_HOST = "localhost";
    private const int DEFAULT_PORT = 1883;
    private const string DEFAULT_TOPIC_PREFIX = "sirocco/mqtt-plugin";
        ...
        CancellationToken connectCancellationToken)
    {
        ...
        try
        {
            MqttClientOptions options = new MqttClientOptionsBuilder()
                ...
                .WithClientId($"sirocco-mqtt-{context.VirtualUserId}-{Guid.NewGuid():N}")
                .Build();
