# Résultats de l'expérience de saturation de l'injecteur

Généré par `benchmark/normalize --saturation` à partir des sorties réelles de
`benchmark/results-saturation/`. Protocole : `benchmark/saturation.sh`.
Commentaire complet : [l'article](../../docs/articles/dette-ordonnancement.md).
