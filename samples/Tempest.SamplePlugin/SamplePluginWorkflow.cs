...
namespace Tempest.SamplePlugin;
...
/// (<c>Tempest.Domain</c>), exactement ce qu'un protocole tiers reel (SQL, MQTT, GraphQL...)
/// utiliserait.
/// <para>
/// Limite assumee de la premiere version du contrat : Tempest n'injecte aucune configuration dans
...
public sealed class SamplePluginWorkflow : IWorkflow
{
    ...
    private const string PATH_ENVIRONMENT_VARIABLE = "TEMPEST_SAMPLE_PLUGIN_PATH";
