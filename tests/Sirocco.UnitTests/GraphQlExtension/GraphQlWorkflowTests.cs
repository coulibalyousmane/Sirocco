...
using Sirocco.Extensions.GraphQl;
using Sirocco.UnitTests.TestDoubles;

namespace Sirocco.UnitTests.GraphQlExtension;
...
public sealed class GraphQlWorkflowTests
{
    ...
    public async Task A_mutation_error_returned_in_the_body_with_http_200_fails_as_an_assertion()
    {
        ...
        // SIROCCO_GRAPHQL_PLUGIN_PRODUCT_ID_MAX tombe toujours sur un identifiant absent,
