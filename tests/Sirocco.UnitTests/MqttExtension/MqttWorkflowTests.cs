...
using Sirocco.Extensions.Mqtt;
using Sirocco.UnitTests.TestDoubles;

namespace Sirocco.UnitTests.MqttExtension;
...
public sealed class MqttWorkflowTests
{
    ...
    private static MqttWorkflow CreateWorkflow(string host, int port, int? timeoutSeconds = null)
    {
        ...
        Environment.SetEnvironmentVariable(TOPIC_PREFIX_ENVIRONMENT_VARIABLE, $"sirocco/tests/{Guid.NewGuid():N}");
