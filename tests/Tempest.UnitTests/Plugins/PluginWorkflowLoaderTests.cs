...
public sealed class PluginWorkflowLoaderTests
{
    ...
    public void A_single_candidate_is_selected_without_a_type_name()
    {
        string path = CompileWorkflowAssembly("""
            public sealed class OnlyWorkflow : Tempest.Domain.Execution.IWorkflow
            {
    ...
    {
        string path = CompileWorkflowAssembly("""
            public sealed class FirstWorkflow : Tempest.Domain.Execution.IWorkflow
            {
            ...
            public sealed class SecondWorkflow : Tempest.Domain.Execution.IWorkflow
            {
    ...
    {
        string path = CompileWorkflowAssembly("""
            internal sealed class HiddenWorkflow : Tempest.Domain.Execution.IWorkflow
            {
            ...
            public sealed class VisibleWorkflow : Tempest.Domain.Execution.IWorkflow
            {
    ...
    {
        string path = CompileWorkflowAssembly("""
            public sealed class RequiresArgumentWorkflow : Tempest.Domain.Execution.IWorkflow
            {
    ...
    /// <c>Tempest.Domain</c>, pour que le source puisse implementer <c>IWorkflow</c>. Meme
    ...
    private static string CompileWorkflowAssembly(string source)
    {
        ...
        string assemblyName = $"TempestPluginTest_{Guid.NewGuid():N}";
