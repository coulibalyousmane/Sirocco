...
using Tempest.Extensions.Sql;
using Tempest.UnitTests.TestDoubles;

namespace Tempest.UnitTests.SqlExtension;
...
public sealed class SqlWorkflowTests
{
    ...
    {
        string path = Path.Combine(Path.GetTempPath(), $"tempest-sql-plugin-test-{Guid.NewGuid():N}.db");
