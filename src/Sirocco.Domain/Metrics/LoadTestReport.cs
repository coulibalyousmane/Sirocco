...
public sealed record LoadTestReport
{
    ...
    /// comment on y est arrive. Vide par defaut : seul <c>Sirocco.Host.LoadTestHostedService</c>
    ...
    /// normalement — voir <c>Sirocco.Host.Distributed.MasterCoordinator.MarkDeadIfStale</c>. Vide
    ...
    {
        string heading = $"Rapport Sirocco — {Scope}";
