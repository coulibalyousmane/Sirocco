    ...
    long BytesReceived)
{
    ...
    public double ServiceMilliseconds => SiroccoClock.ToMilliseconds(ServiceTicks);

    /// <summary>Temps de reponse corrige en millisecondes (hors chemin critique).</summary>
    public double ResponseMilliseconds => SiroccoClock.ToMilliseconds(ResponseTicks);

    /// <summary>Dette d'ordonnancement en millisecondes (hors chemin critique).</summary>
    public double SchedulingDelayMilliseconds => SiroccoClock.ToMilliseconds(SchedulingDelayTicks);
