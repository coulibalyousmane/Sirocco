...
/// <summary>
/// Configuration du tir porte par cet hote. Correspond a la section <c>Sirocco</c> de
/// <c>appsettings.json</c>.
/// </summary>
public sealed class SiroccoHostOptions
{
    ...
    /// <summary>
    /// Ecart entre deux releves de la trajectoire du tir (<see cref="Sirocco.Domain.Metrics.LoadTestReport.TimeSeries"/>),
    ...
    /// <see cref="Sirocco.Application.Execution.RateCappedScheduler"/> pour le detail du mecanisme.
    /// </para>
    /// <para>
    ...
    /// tout endpoint expose. <see langword="null"/> par defaut. C'est <c>Sirocco.Cli</c> qui en a
    ...
    /// <c>Sirocco.Compare</c> sans dependre d'un endpoint HTTP encore actif.
    /// </summary>
