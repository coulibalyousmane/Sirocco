...
/// <summary>
/// Reglages du role <see cref="SiroccoHostOptions.ROLE_MASTER"/>. Section <c>Master</c>.
/// </summary>
public sealed class MasterOptions
{
    ...
    /// leur tir local (voir <see cref="SiroccoHostOptions"/>), pas d'un sondage approximatif.
    /// </summary>
    ...
    /// <see cref="Sirocco.Domain.Metrics.LoadTestReport.LostWorkers"/>), plutot que d'attendre
    ...
    /// profil, voir <c>Sirocco.Operator.TestRunResources.ComputeStageWorkerCounts</c>) : <see langword="null"/>
