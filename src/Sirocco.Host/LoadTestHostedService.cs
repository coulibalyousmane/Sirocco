...
/// <see cref="SiroccoHostOptions.ExitAfterRun"/> — est un choix explicite, pas le defaut.
/// </para>
/// </summary>
    ...
    ILogger<LoadTestHostedService> logger) : BackgroundService
{
    ...
    // fichier est aussi lu par un humain ou par Sirocco.Compare, jamais uniquement par du code.
