...
/// <para>
/// Reste hors de <c>Sirocco.Application</c> parce qu'il a besoin de <see cref="MetricsProcessor"/>
/// (<c>Sirocco.Infrastructure</c>), qui depend deja de <c>Sirocco.Application</c> — l'inverse
