...
public sealed class MasterCoordinator
{
    ...
    /// <para>
    /// Meme signature que <see cref="Sirocco.Application.Metrics.MetricsAggregator.Snapshot(StatisticsScope)"/> :
    ...
    /// <see cref="Infrastructure.Metrics.SiroccoMeter"/> reste utilisable telle quelle, sans
