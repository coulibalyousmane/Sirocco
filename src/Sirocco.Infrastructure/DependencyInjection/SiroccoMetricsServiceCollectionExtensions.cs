...
namespace Sirocco.Infrastructure.DependencyInjection;

/// <summary>
/// Cablage de la chaine de mesure : agregation, consommation du canal, publication.
/// </summary>
public static class SiroccoMetricsServiceCollectionExtensions
{
    /// <summary>
    /// Enregistre l'agregateur, le processeur et les instruments.
    /// <para>
    /// A appeler <b>apres</b> <c>AddSiroccoEngine</c> : l'agregateur dimensionne ses tableaux
    ...
    public static IServiceCollection AddSiroccoMetrics(
        ...
        MetricsAggregatorOptions? options = null)
    {
        ...
        services.TryAddSingleton<SiroccoMeter>();

        // SiroccoMeter n'est demande par aucun autre service : sans ce declencheur, un
    ...
    /// <summary>
    /// Branche OpenTelemetry sur les instruments de Sirocco.
    /// <para>
    ...
    public static IServiceCollection AddSiroccoOpenTelemetry(
        this IServiceCollection services,
        Action<MeterProviderBuilder>? configureMetrics = null)
    {
        ...
        {
            builder.AddMeter(SiroccoMeter.METER_NAME);
