...
namespace Sirocco.Infrastructure.Metrics;

/// <summary>
/// Publie les statistiques du tir sous forme d'instruments <see cref="Meter"/>.
/// <para>
/// Sirocco ne depend d'aucun exportateur : il alimente les instruments standards de la BCL,
...
/// </para>
/// </summary>
public sealed class SiroccoMeter : IDisposable
{
    /// <summary>Nom du <see cref="Meter"/> a ecouter cote collecteur.</summary>
    public const string METER_NAME = "Sirocco";

    private const string LATENCY_INSTRUMENT = "sirocco.latency";
    private const string REQUESTS_INSTRUMENT = "sirocco.requests";
    private const string BYTES_INSTRUMENT = "sirocco.bytes.received";
    private const string SCHEDULING_DELAY_INSTRUMENT = "sirocco.scheduling.delay.max";
    private const string DROPPED_METRICS_INSTRUMENT = "sirocco.metrics.dropped";
    private const string CUSTOM_COUNTER_INSTRUMENT = "sirocco.custom.counter";
    private const string CUSTOM_GAUGE_INSTRUMENT = "sirocco.custom.gauge";
    private const string CUSTOM_RATE_INSTRUMENT = "sirocco.custom.rate";
    private const string CUSTOM_TREND_INSTRUMENT = "sirocco.custom.trend";
    ...
    public SiroccoMeter(MetricsAggregator aggregator, IMeterFactory? meterFactory = null)
    ...
    /// <param name="meterFactory">Fabrique de <see cref="Meter"/> ; une instance autonome si omise.</param>
    public SiroccoMeter(Func<StatisticsScope, LoadTestReport> snapshotProvider, IMeterFactory? meterFactory = null)
    {
