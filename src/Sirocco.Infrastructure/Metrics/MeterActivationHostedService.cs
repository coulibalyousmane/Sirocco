...
/// <summary>
/// Force la construction de <see cref="SiroccoMeter"/> au demarrage de l'hote.
/// <para>
/// Le <see cref="System.Diagnostics.Metrics.Meter"/> et ses instruments ne sont crees qu'a la
/// construction de <see cref="SiroccoMeter"/>. Or rien d'autre ne depend naturellement de
...
/// <see cref="SiroccoMeter"/> dans son constructeur.
/// </para>
/// </summary>
internal sealed class MeterActivationHostedService(SiroccoMeter meter) : IHostedService
{
    /// <inheritdoc />
    public Task StartAsync(CancellationToken cancellationToken)
    {
        // Rien a faire : demander SiroccoMeter au constructeur suffisait a le construire.
