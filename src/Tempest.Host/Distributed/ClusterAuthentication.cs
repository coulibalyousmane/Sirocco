...
/// <para>
/// Desactivee par defaut (<see cref="TempestHostOptions.ClusterSharedSecret"/> a
...
public sealed class ClusterAuthenticationFilter(TempestHostOptions options) : IEndpointFilter
{
    /// <inheritdoc />
