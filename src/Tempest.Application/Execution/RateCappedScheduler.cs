...
/// voulu, pas un effet de bord a corriger. Tempest existe pour montrer ce genre d'ecart, pas pour
/// le masquer.
/// </para>
/// <para>
...
public sealed class RateCappedScheduler : ILoadScheduler
{
        ...
        long spinThresholdTicks) : ChannelWriter<ExecutionToken>
    {
        ...
        private long DueTicks() =>
            startTicks + TempestClock.FromSeconds(Interlocked.Read(ref _forwarded) / maxTokensPerSecond);
    }
}