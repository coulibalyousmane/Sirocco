...
namespace Sirocco.Scenarios.Scripting;
...
/// classe qui implemente l'interface, exactement comme <c>Sirocco.Scenarios</c> le fait pour ses
...
public static class ScriptedWorkflowLoader
{
    ...
    [
        ...
        "Sirocco.Domain.Data",
        "Sirocco.Domain.Execution",
        "Sirocco.Domain.Metrics",
        "Sirocco.Scenarios.Data",
    ];
    ...
    private static ScriptOptions BuildScriptOptions()
    {
        ...
        // a la main : un script qui reference Sirocco.Scenarios (pour DynamicCheckoutWorkflow en
