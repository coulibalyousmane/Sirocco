...
namespace Sirocco.Scenarios.Declarative;
...
/// <para>
/// Duplique volontairement <c>Sirocco.Cli.CliDuration</c> plutot que d'en faire une dependance
/// partagee : les deux couches (CLI, format declaratif) ont chacune leur propre raison de faire
/// evoluer ce format, et <c>Sirocco.Scenarios</c> ne doit pas dependre de <c>Sirocco.Cli</c>.
/// </para>
/// </summary>
